  ...
  try {
    ...
    */
    ...
    app.get('/admin-stats', verifyJWT,verifyAdmin, async(req,res)=>{
      ...
      //best way to get sum of a field is to use group and some operators.
      res.send({
        revenue,
        users,
        products,
    ...
    /****
     * Bangla System (2nd best solution)
     * 1) load all payments
     ...
     * for each category use reduce to get the otal amount spent on this category
     * 
     */
